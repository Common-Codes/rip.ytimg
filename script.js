window.onload = function(){
    ...
    if(src != null){
        image.innerHTML = `<img src="https://i.ytimg.com/vi/${src}/maxresdefault.jpg" onerror="this.src='https://i.ytimg.com/vi/${src}/mqdefault.jpg'" style="border-radius: 4px; width: 100%;">`;
    } else{
